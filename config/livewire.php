...
return [
    ...
    */
    ...
    'payload' => [
        // Büyük sektörel risk şablonları / Excel aday listeleri (Risk Sihirbazı) 1MB'ı
        // aşabiliyor. Çok büyük şablonlar zaten doğrudan uygulanıyor (RiskSihirbazi::
        // sablonUygula) ama esneklik için sınır 6MB'a çekildi.
        'max_size' => 1024 * 1024 * 6,   // 6MB - maximum request payload size in bytes
